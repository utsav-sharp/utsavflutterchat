...
class _SearchPageState extends State<SearchPage> {
 ...
 // FirebaseUser _user;
  ...
  _joinValueInGroup(String userName, String groupId, String groupName, String admin) async {
    bool value = await DatabaseService(uid: widget.userId).isUserJoined(groupId, groupName, userName);
    print("_joinValueInGroup value ${value}");
    setState(() {
      _isJoined = value;
    });
  }
  ...
  Widget groupTile(String userName, String groupId, String groupName, String admin){
    ...
    return ListTile(
      ...
      trailing: InkWell(
        ...
        onTap: () async {
          print("toggaling group join on Tap ${_isJoined} and ${groupId} and ${groupName} and ${userName} ");
         // await DatabaseService(uid: widget.userId).togglingGroupJoin(groupId, groupName, userName);
          print("is join ${_isJoined}");
          if(_isJoined) {
            setState(() {
              _isJoined = !_isJoined;
            });
